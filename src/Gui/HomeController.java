...
public class HomeController {
    ...
    */
    ...
    @FXML
    void BackPosteButtonAction(ActionEvent event) throws IOException {
        Parent addPostesParent = FXMLLoader.load(getClass().getResource("GestionPoste.fxml"));
    ...
    @FXML
    void FrontBlogButtonAction(ActionEvent event) throws IOException {
        Parent postesListParent = FXMLLoader.load(getClass().getResource("ListPoste.fxml"));
    ...
    void handleCommentairesListButtonAction(ActionEvent event) throws IOException {
        Parent commentairesListParent = FXMLLoader.load(getClass().getResource("GestionCommentaire.fxml"));
