   ...
   Session s =new  Session();
    ...
    private void ajouter(ActionEvent event) {
        ...
        if (localdate == null || localdate.compareTo(nowday) < 0) {
            ...
            rc.ajouterReclamation(r,s.getId_user());
    ...
    public void switchToListReclamations(ActionEvent event) {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/changemakers/atpeace/gui/listReclamationsFront.fxml"));	
        try {	
            root = loader.load();
    ...
    public void switchToListReponse(ActionEvent event){
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/changemakers/atpeace/gui/listReponseFront.fxml"));	
        try {	
            root = loader.load();
        } catch (IOException ex) {
            Logger.getLogger(reponsesceneController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    @FXML
    private void retourMenu(MouseEvent event) {
        //String username = nameTextField.getText();
