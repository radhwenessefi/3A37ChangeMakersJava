...
import com.changemakers.atpeace.controller.reponsesceneController;
import com.changemakers.atpeace.services.ReclamationCrud;
 ...
 * @author sami
 */
public class MenuInterfaceControllerRe implements Initializable {
    ...
    private void ajouter(ActionEvent event) {
        ...
        if (localdate == null || localdate.compareTo(nowday) < 0) {
            ...
            String to = "samisellami.99@gmail.com";
            String subject = "New Reclamation Added";
            String message = "A new reclamation with the title \"" + r.getTitre_reclamation() + "\" has been added.";
    ...
    try {
                 Parent loader = FXMLLoader.load(getClass().getResource("/com/changemakers/atpeace/gui/listReponseBack.fxml"));
...
private static final String SMTP_AUTH_USER = "sami.sellami@esprit.tn";
private static final String SMTP_AUTH_PASSWORD = "Lyemna2531";
...
private static final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
    ...
    try {
        ...
        System.out.println("Exception occurred while sending email: " + ex.getMessage());
    }
}
